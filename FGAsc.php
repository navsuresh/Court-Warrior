<?php
	...
	//echo $tempvar;
	$sql = "SELECT * FROM `player_info`\n"."WHERE Tm = \"$tempvar\""."ORDER BY FG ASC";
	$a = array();
...
<html>
  ...
  <script>
   ...
   obj.FGDesc = function()
   {
	   window.location.href="FGDesc.php";
   }
   obj.FTAsc = function()
   {
	   window.location.href="FTAsc.php";
   }
   obj.PlayerAsc = function()
   {
	   window.location.href="PlayerAsc.php";
   }
   obj.PosAsc = function()
   {
  ...
  el2.addEventListener("click",obj.PlayerAsc,false);
  ...
  el5.addEventListener("click",obj.FGDesc,false);
  ...
  el8.addEventListener("click",obj.ASTDesc,false);
